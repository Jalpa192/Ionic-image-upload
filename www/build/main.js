...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_transfer__ = __webpack_require__(194);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_firebase__ = __webpack_require__(197);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_firebase___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_firebase__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_base64__ = __webpack_require__(274);
...
var HomePage = (function () {
    function HomePage(navCtrl, camera, transfer, file, filePath, actionSheetCtrl, toastCtrl, platform, loadingCtrl, base64) {
    ...
    HomePage.prototype.uploadImageToFirebase = function () {
        var _this = this;
        var storageRef = __WEBPACK_IMPORTED_MODULE_6_firebase___default.a.storage().ref();
        // Create a timestamp as filename
        var filename = Math.floor(Date.now() / 1000);
        // Create a reference to 'images/todays-date.jpg'
        this.base64.encodeFile(this.pathForImage(this.lastImage)).then(function (base64File) {
            //console.log(base64File);
            _this.captureDataUrl = base64File;
            console.log("this.captureDataUrl", _this.captureDataUrl);
            var imageRef = storageRef.child("images/" + _this.lastImage); //${filename}.jpg`);
            console.log("imageRef", imageRef);
            imageRef.putString(_this.captureDataUrl, __WEBPACK_IMPORTED_MODULE_6_firebase___default.a.storage.StringFormat.DATA_URL).then(function (snapshot) {
...
HomePage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-home',template:/*ion-inline-start:"D:\POCS\ionic Demos\ImageUploadDemo\src\pages\home\home.html"*/'<ion-header>\n    <ion-navbar color="primary">\n        <ion-title>\n            Image Upload\n        </ion-title>\n    </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n    <img src="{{pathForImage(lastImage)}}" style="width: 100%" [hidden]="lastImage === null">\n    <h3 [hidden]="lastImage !== null">Please Select Image!</h3>\n</ion-content>\n\n<ion-footer>\n    <ion-toolbar color="primary">\n        <ion-buttons>\n            <button ion-button icon-left (click)="presentActionSheet()">\n        <ion-icon name="camera"></ion-icon>Select Image\n      </button>\n            <button ion-button icon-left (click)="uploadImage()" [disabled]="lastImage === null">\n        <ion-icon name="cloud-upload"></ion-icon>Upload\n      </button>\n            \n    <button ion-button icon-left (click)="uploadImageToFirebase()" [disabled]="lastImage === null">\n        <ion-icon name="cloud-upload"></ion-icon>Upload to firebase\n    </button>\n        </ion-buttons>\n    </ion-toolbar>\n</ion-footer>'/*ion-inline-end:"D:\POCS\ionic Demos\ImageUploadDemo\src\pages\home\home.html"*/,
        providers: [__WEBPACK_IMPORTED_MODULE_7__ionic_native_base64__["a" /* Base64 */]]
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_5__ionic_native_camera__["a" /* Camera */], __WEBPACK_IMPORTED_MODULE_3__ionic_native_transfer__["a" /* Transfer */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_file__["a" /* File */], __WEBPACK_IMPORTED_MODULE_4__ionic_native_file_path__["a" /* FilePath */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* ActionSheetController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* ToastController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* Platform */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* LoadingController */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_file__ = __webpack_require__(193);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_transfer__ = __webpack_require__(194);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_file_path__ = __webpack_require__(195);
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"D:\POCS\ionic Demos\ImageUploadDemo\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"D:\POCS\ionic Demos\ImageUploadDemo\src\app\app.html"*/
    }),
